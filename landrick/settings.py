"""
Django settings for landrick project.
...
ALLOWED_HOSTS = ['*', 'https://coin100.vn/', 'coin100.vn', 'www.coin100.vn']
...
WSGI_APPLICATION = 'landrick.wsgi.application'
